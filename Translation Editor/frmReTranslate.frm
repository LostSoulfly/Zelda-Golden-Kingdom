...
If t Is Nothing Then Set t = New GTranslate.DLL
    optBing.Caption = t.BingTranslate(strTo, strFrom, text)
    optGoogle.Caption = t.GoogleTranslate(strTo, strFrom, text)
    optYandex.Caption = t.YandexTranslate(strTo, strFrom, text)

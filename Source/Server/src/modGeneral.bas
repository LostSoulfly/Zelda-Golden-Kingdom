...
Load frmTransLog
frmTransLog.Show
frmTransLog.txtLog.Text = "GTranslate Removal 2023"
...
Public Sub InitServer()
    ...
    If Not FileExist(App.Path & "\data\options.ini", True) Then
        ...
        Options.Instructions = "Your client is out of date! Please run the Launcher to be updated to the current version." '"Download")

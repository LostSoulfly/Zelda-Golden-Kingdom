...
If IsPlaying(EditUserIndex) = False Then
    Call AddInfo("The player is offline!")
    Exit Sub
End If
...
Call PlayerMsg(FindPlayer(Name), "Your level has been changed to " & Player_Level & level, BrightCyan)
End If
End Sub

...
Sub BanIndex(ByVal BanPlayerIndex As Long, ByVal BannedByIndex As Long)
    ...
    Close #F
    Call GlobalMsg(GetPlayerName(BanPlayerIndex) & " has been banned by " & GetPlayerName(BannedByIndex) & "!", White, False)
    ForwardGlobalMsg "[Hub - " & SERVER_NAME & "] " & GetPlayerName(BanPlayerIndex) & " has been banned by " & GetPlayerName(BannedByIndex) & "!"
    Call AddLog(BannedByIndex, GetPlayerName(BannedByIndex) & " has banned " & GetPlayerName(BanPlayerIndex) & ".", ADMIN_LOG)
...
If frmServer.chkTroll.Value = vbChecked Then Exit Sub
    ...
    Print #F, IP & "," & "Server"
    Close #F
    Call GlobalMsg(GetPlayerName(BanPlayerIndex) & " has been banned by the Server" & "!", White, False)
        ForwardGlobalMsg "[Hub - " & SERVER_NAME & "] " & GetPlayerName(BanPlayerIndex) & " has been banned!"
    Call AddLog(0, "The Server has benned " & GetPlayerName(BanPlayerIndex) & ".", ADMIN_LOG)
...
Sub LoadClasses()
    ...
    For i = 1 To Max_Classes
        ...
        'Class(i).OriginalName = GetVar(FileName, "CLASS" & i, "OriginalName")
...
Sub SaveClasses()
    ...
    For i = 1 To Max_Classes
        Call PutVar(FileName, "CLASS" & i, "Name", Class(i).Name)
        'If (Trim$(Replace(Class(i).OriginalName, vbNullChar, "")) = "") Then Call PutVar(FileName, "CLASS" & i, "OriginalName", Trim$(Class(i).Name))
...
Sub SaveItems()
    ...
    For i = 1 To MAX_ITEMS
        'item(i).Name = GetTranslation(item(i).Name)
        'item(i).Desc = GetTranslation(item(i).Desc)
        Call SaveItem(i)
    Next
...
Sub LoadItems()
    ...
    For i = 1 To MAX_ITEMS
        ...
        Get #F, , item(i)
        Close #F
        'If Trim$(Replace(item(i).Name, vbNullChar, "")) = "" Then item(i).Name = GetTranslation(item(i).Name)
    Next
...
Sub LoadShops()
    ...
    For i = 1 To MAX_SHOPS
        ...
        Get #F, , Shop(i)
        Close #F
        'If Trim$(Replace(Shop(i).Name, vbNullChar, "")) = "" Then Shop(i).Name = GetTranslation(Shop(i).Name)
    Next
...
Sub SaveSpell(ByVal spellNum As Long)
    ...
    FileName = App.Path & "\data\spells\spells" & spellNum & ".dat"
        ...
        'AddTransLog ("SaveSpell " & spellNum)
        'Spell(spellNum).Desc = GetTranslation(Spell(spellNum).Desc)
        'Spell(spellNum).Name = GetTranslation(Spell(spellNum).Name)
...
Sub LoadSpells()
    ...
    For i = 1 To MAX_SPELLS
        ...
        Get #F, , Spell(i)
        Close #F
        'If Trim$(Replace(Spell(i).Name, vbNullChar, "")) = "" Then Spell(i).Name = GetTranslation(Spell(i).Name)
    Next
...
Sub SaveNpc(ByVal npcnum As Long)
    ...
    'AddTransLog ("SaveNpc" & npcnum)
    'NPC(npcnum).AttackSay = GetTranslation(NPC(npcnum).AttackSay)
    'NPC(npcnum).Name = GetTranslation(NPC(npcnum).Name)
...
Sub LoadNpcs()
    ...
    For i = 1 To MAX_NPCS
        ...
        Get #F, , NPC(i)
        Close #F
        'If Trim$(Replace(NPC(i).Name, vbNullChar, "")) = "" Then NPC(i).Name = GetTranslation(NPC(i).Name)
    Next
...
Sub SaveResource(ByVal ResourceNum As Long)
    ...
    'AddTransLog ("SaveResource" & ResourceNum)
    'Resource(ResourceNum).Name = GetTranslation(Resource(ResourceNum).Name)
    'Resource(ResourceNum).SuccessMessage = GetTranslation(Resource(ResourceNum).SuccessMessage)
    'Resource(ResourceNum).EmptyMessage = GetTranslation(Resource(ResourceNum).EmptyMessage)
...
Sub LoadResources()
    ...
    For i = 1 To MAX_RESOURCES
        ...
        Open FileName For Binary As #F
            Get #F, , Resource(i)
        Close #F
        'If Trim$(Replace(Resource(i).Name, vbNullChar, "")) = "" Then Resource(i).Name = GetTranslation(Resource(i).Name)
...
Sub LoadAnimations()
    ...
    For i = 1 To MAX_ANIMATIONS
        ...
        Open FileName For Binary As #F
            Get #F, , Animation(i)
        Close #F
        'If Trim$(Replace(Animation(i).Name, vbNullChar, "")) = "" Then Animation(i).Name = GetTranslation(Animation(i).Name)
    Next
...
Sub LoadDoors()
    ...
    For i = 1 To MAX_DOORS
        ...
        Open FileName For Binary As #F
            Get #F, , Doors(i)
        Close #F
        'If Trim$(Replace(Doors(i).Name, vbNullChar, "")) = "" Then Doors(i).Name = GetTranslation(Doors(i).Name)
    Next
...
Sub LoadActions()
    ...
    For i = 1 To MAX_ACTIONS
        ...
        Close #F
        'If Trim$(Replace(Actions(i).Name, vbNullChar, "")) = "" Then Actions(i).Name = GetTranslation(Actions(i).Name)

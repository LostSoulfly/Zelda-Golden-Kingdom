...
Public Sub SendQuestion(ByVal question As Byte)
    ...
    Case WarpMeTo
        Call SendQuestionData(m, "teleport", GetPlayerName(N) & "he wants to teleport to you, will you let him?")
    Case WarpToMe
        Call SendQuestionData(m, "teleport", GetPlayerName(N) & "he wants to teleport you, will you let him?")
    End Select
End Sub

...
End If
    ...
    Load frmTransLog
    frmTransLog.txtLog.text = "2023 Update. GTranslate Removed, TranslationServer added."
    'frmTransLog.Show
    ...
    ' load options
    Call SetStatus("Loading Options\Translation...")
    LoadOptions
    ...
    Randomize
    Call SetStatus("Starting TCP settings...")
    Call TcpInit
    Call InitMessages
    Call SetStatus("Starting DirectX...")
    ...
    Select Case State
        Case MENU_STATE_ADDCHAR
            ...
            If ConnectToServer(1) Then
                Call SetStatus("Logged in, sending character information...")
        ...
        Case MENU_STATE_NEWACCOUNT
            ...
            If ConnectToServer(1) Then
                Call SetStatus("Logged in, sending new account information...")
        ...
        Case MENU_STATE_LOGIN
            ...
            If ConnectToServer(1) Then
                Call SetStatus("Connected, receiving data...")
...
.lblGuildFounder.Caption = "Make Guild Master"
.lblGuildAdminPanel.Caption = "Manage Guild"
.lblGuildTransfer.Caption = "Transfer Guild"
Else
.lblGuild.Caption = "You are not in a guild."
.lblGuildC.Caption = "Create Guild"
.lblGuildCAccept.Caption = "Create"
.lblGuildCCancel.Caption = "Cancel"
.frmGuildC.Caption = "Create Guild"""
.txtGuildC.text = ""
.picGuildInvitation.Visible = False
.lblGuildInvitation.Caption = "Invite to Guild"
.lblGuildAcceptInvitation.Caption = "Accept"
.lblGuildDeclineInvitation.Caption = "Decline"
End If

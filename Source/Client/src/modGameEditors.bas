...
Dim i As Long
    ...
    With frmEditor_MapProperties
        ...
        For X = 0 To MAX_ACTIONS
            ...
            Else
            .cmbAction.AddItem X & ": " & Trim$(Actions(X).Name)
            End If
        Next
...
Dim index As Byte
    ...
    With Item(EditorIndex)
        ...
        frmEditor_Item.txtDesc.ToolTipText = .Desc
        DoEvents
    ...
    For i = 1 To MAX_TRADES
        With Shop(EditorIndex).TradeItem(i)
            ...
            Else
                ...
                Else
                    frmEditor_Shop.lstTradeItem.AddItem i & ": " & .ItemValue & "x " & Trim$(Item(.Item).Name) & " for " & .CostValue & " points"
                End If
            End If
        End With
    Next
...
Dim SoundSet As Boolean
    ...
    With frmEditor_Spell
        ...
        .txtDesc.ToolTipText = .txtDesc.text
        DoEvents

...
PlayerMsg i, "The time to accept invitation to the clan is exhausted" & GuildData(TempPlayer(i).tmpGuildInviteSlot).Guild_Name & ".", BrightRed
...
Private Sub HandleShutdown()
    ...
    If Secs Mod 5 = 0 Or Secs <= 5 Then
        Call GlobalMsg("Shutdown of the Server in: " & Secs & " seconds.", BrightBlue)

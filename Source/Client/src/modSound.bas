...
Public Const Sound_ButtonClick2 As String = "Decision2.wav"
Public Const Sound_ButtonInitiating As String = "Iniciando.wav"
Public Const Sound_ButtonEnding As String = "Terminando.wav"
Public Const Sound_ButtonClose As String = "Cerrar.wav"
Public Const Sound_ButtonParty As String = "Equipo.wav"
Public Const Sound_ButtonQuest As String = "Quest.wav"
Public Const Sound_ButtonAccept As String = "Aceptar.wav"
Public Const Sound_ButtonCancel As String = "Cancelar.wav"
Public Const Sound_ButtonChange As String = "Cambiar.wav"
Public Const Sound_ButtonTriforce As String = "Reset.wav"
Public Const Sound_ButtonDialogue As String = "Conversación.wav"
Public Const Sound_ButtonChatBox As String = "ChatBox.wav"
Public Const Sound_ButtonMiniMapOn As String = "MiniMap_On.wav"
Public Const Sound_ButtonMiniMapOff As String = "MiniMap_Off.wav"

Public mp3Player As FilgraphManager
...
Dim Splitmusic() As String
    ...
    Set Segment = Nothing
    Set Segment = Loader.LoadSegment(CStr(App.Path & MUSIC_PATH & FileName))
    'Set Segment = Loader.LoadSegment("abc")

    ' repeat midi file
    Segment.SetLoopPoints 0, 0
    Segment.SetRepeats -1
...
Public Sub PlayMp3(ByVal FileName As String)
    ...
    ' Check to see if DirectSound was successfully initalized.
    If Not Sound_On Or Not FileExist(App.Path & MUSIC_PATH & FileName, True) Then Exit Sub
    
    ' make sure it's a valid file
    If Not Right$(FileName, 4) = ".mp3" Then Exit Sub
    
    Set mp3Player = New FilgraphManager
    mp3Player.RenderFile App.Path & MUSIC_PATH & FileName
    mp3Player.Run
End Sub
...
Public Sub MusicPlay(ByVal FileName As String)

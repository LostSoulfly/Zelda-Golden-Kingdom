...
Dim X As Long, Y As Long, i As Long, rec As RECT
    ...
    AddText "Screenshot #" & GetPlayerMap(MyIndex) & " saved.", BrightGreen
...
Dim tmpItem As Long, amountModifier As Long
    ...
    ' reset gold label
    frmMain.lblGold.Caption = "0 " & "Rupees"
...
End If
    ...
    If Not Options.MappingMode = 1 Then
        ...
        Else
            Call DrawText(TexthDC, Camera.Right - 305, Camera.Top + 35, "Safe Mode Off", QBColor(BrightRed))
        End If
    End If
...
Else
    colour = QBColor(White)
End If
frmMain.lblGold.Caption = Format$(amount, "#,###,###,###") & " Rupees"

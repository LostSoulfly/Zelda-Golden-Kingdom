...
Dim TNL As Long
    ...
    TNL = Buffer.ReadLong
    frmMain.lblExp.Caption = "Experience:" & GetPlayerExp(MyIndex) & "/" & TNL
    ' mp bar
...
Dim i As Long
    ...
    If dataType = 0 Then ' ours!
        ...
        Next
        frmMain.lblYourWorth.Caption = Buffer.ReadLong & "Rupees"
    ...
    ElseIf dataType = 1 Then 'theirs
        ...
        Next
        frmMain.lblTheirWorth.Caption = Buffer.ReadLong & "Rupees"
    End If
...
Dim tradeStatus As Byte
    ...
    Select Case tradeStatus
        ...
        Case 1 ' they've accepted
            frmMain.lblTradeStatus.Caption = "The other player has accepted."
        Case 2 ' you've accepted
            frmMain.lblTradeStatus.Caption = "Waiting for the other player to accept."
    End Select
...
Dim theName As String
    ...
    Dialogue "Trade request", theName & " " & " asks you to trade. Do you accept?", DIALOGUE_TYPE_TRADE, True
...
Dim theName As String
    ...
    Dialogue "Party Invite", theName & " " & " invites you to party. Accept?", DIALOGUE_TYPE_PARTY, True
...
Private Sub HandleQuestMessage(ByVal index As Long, ByRef Data() As Byte, ByVal StartAddr As Long, ByVal ExtraVar As Long)
    ...
    'todo?
    frmMain.lblQuestName = (Quest(QuestNum).Name)

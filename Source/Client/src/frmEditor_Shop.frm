...
Begin VB.Form frmEditor_Shop 
   ...
   Visible         =   0   'False
   Begin VB.Frame fraLinearPrice 
      Caption         =   "Price(Linear)"
      Height          =   1455
      Left            =   9480
      TabIndex        =   21
      Top             =   1920
      ...
      Begin VB.ComboBox cmbX 
         Height          =   300
         ItemData        =   "frmEditor_Shop.frx":0A4E
         Left            =   120
         List            =   "frmEditor_Shop.frx":0A55
         TabIndex        =   29
         Text            =   "In Function of"
         Top             =   240
         Width           =   1575
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   120
      Width           =   6015
      Begin VB.ComboBox cmbPriceWay 
         Height          =   300
         ItemData        =   "frmEditor_Shop.frx":0A60
         Left            =   5040
         List            =   "frmEditor_Shop.frx":0A6A
         TabIndex        =   30
         Text            =   "Way"
         Top             =   1680
         Width           =   855
      ...
      Begin VB.ComboBox cmbPriceType 
         Height          =   300
         ItemData        =   "frmEditor_Shop.frx":0A80
         Left            =   3960
         List            =   "frmEditor_Shop.frx":0A82
         TabIndex        =   28
         Text            =   "Type "
         Top             =   1680
         Width           =   975
      ...
      Begin VB.ListBox lstTradeItem 
         Height          =   1860
         ItemData        =   "frmEditor_Shop.frx":0A84
         Left            =   120
         List            =   "frmEditor_Shop.frx":0AA0
         TabIndex        =   10
         Top             =   2400
         Width           =   5055
      End
...
Private Sub cmbPriceType_Click()
    Shop(EditorIndex).PriceType = cmbPriceType.ListIndex
End Sub

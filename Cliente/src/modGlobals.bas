...
Public BlockedActions(1 To PlayerActionsType.PlayerActions_Count - 1) As Boolean
...
'Used for map Script Tile
Public MapEditorScriptNum As Long
...
Public Movement_Changed(1 To MAX_MOVEMENTS) As Boolean
Public Action_Changed(1 To MAX_ACTIONS) As Boolean
Public Pet_Changed(1 To MAX_PETS) As Boolean
Public CustomSprite_Changed(1 To MAX_CUSTOM_SPRITES) As Boolean
...
'Used for drops information
Public DropsInfo(1 To MAX_NPC_DROPS) As NPCDropInfoRec

'Used for resource rewards information
Public RewardsInfo(1 To MAX_RESOURCE_REWARDS) As ResourceRewardInfoRec

Public SelectedTriforce As Byte

Public ActualChatRoom As Byte

...
Begin VB.Form frmEditor_Map 
   ...
   Begin VB.PictureBox picAttributes 
      ...
      Begin VB.Frame fraSlide 
         ...
         Begin VB.ComboBox cmbSlide 
            Height          =   300
            ItemData        =   "frmEditor_Map.frx":0A4E
            Left            =   240
            List            =   "frmEditor_Map.frx":0A5E
      ...
      Begin VB.Frame fraHeal 
         ...
         Begin VB.ComboBox cmbHeal 
            Height          =   300
            ItemData        =   "frmEditor_Map.frx":0A79
            Left            =   240
            List            =   "frmEditor_Map.frx":0A83
            Style           =   2  'Dropdown List
            TabIndex        =   81
            Top             =   240
            Width           =   2895
   ...
   Begin VB.Frame fraAttribs 
      ...
      Visible         =   0   'False
      Width           =   1455
      Begin VB.CommandButton cmdFillEmptyAttributes 
         Caption         =   "Fill Empty"
         Height          =   270
         Left            =   120
         TabIndex        =   102
...
Private Sub cmdFillEmptyAttributes_Click()
    Call FillEmptyAttributes
End Sub
...
Private Sub cmdScript_Click()
    MapEditorScriptNum = scrlScript.value
    picAttributes.Visible = False
...
Private Sub cmdSend_Click()
    ...
    frmMain.PicBars(1).Visible = True
    frmMain.PicBars(2).Visible = True
    SaveOptions
...
Private Sub scrlMapItem_Change()
    ...
    If isItemStackable(scrlMapItem.value) Then
...
Private Sub scrlScript_Scroll()
    scrlScript_Change
End Sub

Private Sub scrlScript_Change()
    lblScript.Caption = "Number: " & scrlScript.value
End Sub

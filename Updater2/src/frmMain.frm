...
If FileExist(App.Path & "\" & "Starter.exe") Then Shell App.Path & "\" & "Starter.exe", vbNormalFocus
End Sub
...
If FileExist(Environ("windir") & "\System32\MSWINSCK.OCX") Or FileExist(Environ("windir") & "\SysWow64\MSWINSCK.OCX") Then
    If FileExist(Environ("windir") & "\System32\Richtx32.ocx") Or FileExist(Environ("windir") & "\SysWow64\Richtx32.ocx") Then
        If MsgBox("It doesn't seem like you need to install the VB6 runtime/libraries. Do you want to anyway?", vbYesNo) = vbYes Then If FileExist(App.Path & "\" & "Librerías.exe") Then Shell App.Path & "\" & "Librerías.exe", vbNormalFocus
    End If
End If
End Sub
